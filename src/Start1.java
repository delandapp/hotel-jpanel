...
public class Start1 extends javax.swing.JFrame {
                ...
                for (int i = 0; i <= 100; i++) {
                    try {
                        ...
                        if(jProgressBar1.getString().equals("25%")){
                            jLabel2.setText("Connecting Database Delnis....");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELNIS HOTEL");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 370, 53));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/hotel2.jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 450));
